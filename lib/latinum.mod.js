 ...
 */
	...
	this.init = function() {
		contentLoader.addExtensions(renderers.listExtensions());
		return new Promise(function (resolve, reject) {
			defnLoader.init().then(function() {
				defnLoader.dumpSiteData();
				if(defnLoader.siteId() != null) {
					contentLoader.setSiteId(defnLoader.siteId());
				}
				contentLoader.init().then(function() {
